...
while not glfw.window_should_close(window):
    ...
    lightPos = glm.vec3( .5*math.cos(currentFrameTime),
                         .5*math.sin(currentFrameTime), 0.0 )
    ...
    shaders.setUniform3f("material.specular", 0.5, 0.5, 0.5)
    shaders.setUniform1f("material.shininess", 32.0);

    lightColor = glm.vec3()
    lightColor.x = math.sin(currentFrameTime * 2.0)
    lightColor.y = math.sin(currentFrameTime * 0.7)
    lightColor.z = math.sin(currentFrameTime * 1.3)
